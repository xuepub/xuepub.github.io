function social_tools( src , title ){
    ...
    '<a href="https://twitter.com/share" class="twitter-share-button" data-url="' + location.href + '" data-text="' + title + '" data-count="horizontal">Tweet</a><script type="text/javascript" src="widgets.js"/*tpa=http://platform.twitter.com/widgets.js*/></script>' +
    ...
    '<img border="0" src="PinExt.png"/*tpa=http://assets.pinterest.com/images/PinExt.png*/ title="Pin It" /></a><script type="text/javascript" src="pinit.js"/*tpa=http://assets.pinterest.com/js/pinit.js*/></script>' + 
